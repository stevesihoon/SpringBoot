...
2. POST :  (USE POSTMAN TO TEST)
    1. /person/new - create a new Owner (Requires PostMan JSON request) Example request { "id":"Something", "password":"Something else", "address":"here", "telephone":"some number" } </br>
